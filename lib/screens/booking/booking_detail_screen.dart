...
class _BookingDetailScreenState extends State<BookingDetailScreen> {
  ...
  Widget handymanWidget(
      {required List<UserData> handymanList, required ServiceData serviceDetail, required BookingData bookingDetail}) {
  ...
  Widget providerWidget({required BookingDetailResponse res}) {
    ...
    return Column(
      ...
      children: [
        ...
        16.height,
        BookingDetailProviderWidget(providerData: res.providerData!).onTap(
          () {
            ProviderInfoScreen(providerId: res.providerData!.id.validate()).launch(context);
          },
          hoverColor: Colors.transparent,
          highlightColor: Colors.transparent,
          splashColor: Colors.transparent,
  ...
  Widget customerReviewWidget(
      {required List<RatingData> ratingList, required RatingData? customerReview, required BookingData bookingDetail}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
                    ...
                    showInDialog(
                      ...
                      builder: (p0) {
                        return AddReviewDialog(
                            serviceId: bookingDetail.serviceId.validate(), bookingId: bookingDetail.id.validate());
                      },
                    ).then((value) {
                      if (value) {
                        setState(() {});
  ...
  Widget descriptionWidget({required BookingDetailResponse value}) {
    if (value.bookingDetail!.description.validate().isNotEmpty)
      return Column(
        ...
        children: [
          16.height,
          Text("${language.booking.split('s').join(' ')}${language.hintDescription}",
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          /// Service Details
                          serviceDetailWidget(
                              bookingDetail: snap.data!.bookingDetail!, serviceDetail: snap.data!.service!),
                          16.height,
                          Divider(height: 0),
