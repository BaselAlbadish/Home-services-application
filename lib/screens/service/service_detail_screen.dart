...
class ServiceDetailScreen extends StatefulWidget {
  ...
  ServiceDetailScreen({this.providerId,required this.serviceId});
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ServiceDetailResponse>(
      ...
      builder: (context, snap) {
        //ToDO
        UserData userData = UserData(providerId: 10,email: "baselalbadish@gmail.com",contactNumber: "0935449677");
        snap.data!.provider = userData;
        return Scaffold(
