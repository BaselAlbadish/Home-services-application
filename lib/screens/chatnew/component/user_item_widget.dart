...
import 'package:booking_system_flutter/screens/chatnew/user_chat_screen.dart';
    ...
    return StreamBuilder<UserData>(
      ...
      builder: (context, snap) {
        if (snap.hasData) {
          ...
          return InkWell(
            onTap: () async {
              UserChatScreens(receiverUser: data).launch(context, pageRouteAnimation: PageRouteAnimation.Fade, duration: 300.milliseconds);
            },
            child: Container(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          StreamBuilder<int>(
                            stream: chatMessageService.getUnReadCount(senderId: appStore.uid.validate(), receiverId: data.uid.validate()),
                            builder: (context, snap) {
                              if (snap.hasData) {
                                if (snap.data != 0) {
                                  return Container(
